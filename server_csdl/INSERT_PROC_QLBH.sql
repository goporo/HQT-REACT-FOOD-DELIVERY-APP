...
BEGIN TRAN
	...
	VALUES
		(@MAQTV, @EMAIL, @MATK, @TEN, @SDT, @NGAYTG, @HINHANHND, @DIACHIHINHANHND, @LUONGQTV, @MATKNGANHANG, @MADIACHI)
	END TRY
	BEGIN CATCH
		PRINT N'LỖI HỆ THỐNG'
		ROLLBACK TRAN
...
BEGIN TRAN 
	...
	INSERT INTO DOITAC
	VALUES
		(@MADOITAC, @EMAILDT, @TENDT, @NGAYTG, @HINHANHND, @DIACHIHINHANHND, @SDTDT, @MSTHUE,	@MAIL_NDD, @SLDUKIENMIN, @SLDUKIENMAX, @MATKNGANHANG, @MATK, @MADIACHI, @NGAYKT)
	END TRY
	BEGIN CATCH
		PRINT N'LỖI HỆ THỐNG'
		ROLLBACK TRAN

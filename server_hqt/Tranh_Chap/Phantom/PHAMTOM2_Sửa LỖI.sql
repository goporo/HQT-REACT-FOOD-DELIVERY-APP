...
IF EXISTS (SELECT * FROM HOPDONG HD JOIN THONGTIN_HOPDONG  TTHD WITH (tabLOCKX) ON TTHD.MAHD=HD.MAHD WHERE HD.MAHD=@MAHD AND HD.MADOITAC=@MADT AND TTHD.MANHANVIEN=NULL)
BEGIN

...
AS
	...
	ELSE
	BEGIN
	SELECT * FROM DON_DH DH JOIN KHACHHANG KH ON DH.MAKH=KH.MAKH LEFT JOIN TAIXE TX ON DH.MATX=TX.MATX JOIN CHINHANH CN ON DH.MACN=CN.MACN JOIN CUAHANG CH ON CH.MACN=CN.MACN JOIN THUCDONDATHANG TDDH ON TDDH.MADH= DH.MADH JOIN THUCDON TD ON TD.MAMONAN=TDDH.MAMONAN
